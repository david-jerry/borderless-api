...
class RegisterSerializer(serializers.Serializer):
    username = None  # serializers.CharField(max_length=get_username_max_length(),min_length=allauth_account_settings.USERNAME_MIN_LENGTH,required=allauth_account_settings.USERNAME_REQUIRED,)
